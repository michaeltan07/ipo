...
logit.model_0.2 = glm(data = train,formula = Underpriced ~ VIX_before + market_performance  + Selling.and.Marketing + Net.Income.Margin + RevGrowth + Total.Assets + log(Proceeds) + Type.of.Security + RevGrowth + Total.VC.Funding.Raised + Selling.and.Marketing:RevGrowth + market_performance:Selling.and.Marketing, family=binomial(link='logit'))
...
for(i in 1:10){
  logit.model_0.2_cv = glm(data = train_list[[i]], formula = Underpriced ~ VIX_before + market_performance  + Selling.and.Marketing + Net.Income.Margin + RevGrowth + Total.Assets + log(Proceeds) + Type.of.Security + RevGrowth + Total.VC.Funding.Raised + Selling.and.Marketing:RevGrowth + market_performance:Selling.and.Marketing, family=binomial(link='logit'))
...
logit.model_0.1 = glm(data = train, formula = Underpriced ~ VIX_before + market_performance  + Selling.and.Marketing + Net.Income.Margin + RevGrowth + Total.Assets + log(Proceeds) + Type.of.Security + RevGrowth + Total.VC.Funding.Raised + Selling.and.Marketing:RevGrowth + market_performance:Selling.and.Marketing, family=binomial(link='logit'))
...
for(i in 1:10){
  logit.model_0.1_cv = glm(data = train_list[[i]], formula = Underpriced ~ VIX_before + market_performance  + Selling.and.Marketing + Net.Income.Margin + RevGrowth + Total.Assets + log(Proceeds) + Type.of.Security + RevGrowth + Total.VC.Funding.Raised + Selling.and.Marketing:RevGrowth + market_performance:Selling.and.Marketing, family=binomial(link='logit'))
...
logit.model_0 = glm(data = train, formula = Underpriced ~ VIX_before + market_performance  + Selling.and.Marketing + Net.Income.Margin + RevGrowth + Total.Assets + log(Proceeds) + Type.of.Security + RevGrowth + Total.VC.Funding.Raised + Selling.and.Marketing:RevGrowth + market_performance:Selling.and.Marketing, family=binomial(link='logit'))
...
logit.model_0_auc = c()
for(i in 1:10){
  logit.model_0_cv = glm(data = train_list[[i]], formula = Underpriced ~ VIX_before + market_performance  + Selling.and.Marketing + Net.Income.Margin + RevGrowth + Total.Assets + log(Proceeds) + Type.of.Security + RevGrowth + Total.VC.Funding.Raised + Selling.and.Marketing:RevGrowth + market_performance:Selling.and.Marketing, family=binomial(link='logit'))
