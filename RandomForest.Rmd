...
model.1 = lm(data = ipos.clean, formula = LogOneDayChange ~ VIX_before + market_performance  + Selling.and.Marketing + Net.Income.Margin + RevGrowth + Total.Assets + log(Proceeds) + Type.of.Security + RevGrowth + Total.VC.Funding.Raised + Selling.and.Marketing:RevGrowth + market_performance:Selling.and.Marketing)
summary(model.1)
